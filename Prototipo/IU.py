...
class Interfaz(tk.Tk):
    def __init__(self, icono_image_path="./fonts/icono.png"):
        ...
        self.extra_number = tk.StringVar()
        ...
        self.extra_label = tk.Label(self.id_button_frame, text="N. Recomendaciones:", font=("Milky Vintage", 20), bg="lightblue")
        self.extra_label.grid(row=1, column=0, padx=5)
        self.extra_entry = tk.Entry(self.id_button_frame, textvariable=self.extra_number, font=("Milky Vintage", 20), width=10, justify="center")
        self.extra_entry.grid(row=1, column=1, padx=5)
        self.extra_entry.config(validate="key", validatecommand=(self.register(self.validate_id), "%P"))
    ...
    def recommend(self):
        ...
        user_extra_number = self.extra_number.get() or 5
        resultado = recomendacion.recomendar(user= int(user_id_text), generos= app.get_user_selection()["generos"], decadas = app.get_user_selection()["epoca"], tags = app.get_user_text_tags(), top_n = int(user_extra_number))

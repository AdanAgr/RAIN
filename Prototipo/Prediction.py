...
class Prediction:
    ...
    def filtrar_peliculas(self, generos=None, decadas=None, tags=None):
        ...
        if generos:
            ...
            if peliculas_filtradas_and.empty:
                print("No se han encontrado películas que contengan todos los géneros ajustados. Usando filtro Or.")
        ...
        if peliculas_filtradas.empty:
            print("No se han encontrado películas para estas especificaciones, aquí tiene una lista de películas que creemos le gustarán:")
            peliculas_filtradas = self.movies_data
    ...
    def recomendar_peliculas(self, generos=None, decadas=None, tags=None,top_n=5):

...
class MultiSelectDropdown(tk.Toplevel):
    def __init__(self, parent, options, title="Seleccione opciones", background_image_path=None, icono_image_path="icono.png"):
...
class App(tk.Tk):
    def __init__(self, icono_image_path="icono.png"):
        super().__init__()
        ...
        self.background_image_paths = {
            "Géneros": "fondo_generos.jpg",  # Imagen de fondo para Géneros
            "Época": "fondo_epocas.jpg"      # Imagen de fondo para Época
        }
        ...
        self.dropdown1.bind("<Button-1>", lambda e: self.show_multiselect("Géneros", ["Acción", "Aventura", "Animación", "Para todos los públicos", "Comedia", "Policiaca", "Documental", "Drama", "Fantasía", "Cine Negro", "Terror", "Musical", "Misterio", "Romance", "Ciencia Ficción", "Thriller / Suspense", "Cine Bélico", "Western / Vaqueros"], self.dropdown1, "Géneros"))
        self.dropdown1.pack(pady=5)

        # Desplegable de Época
        ...
        self.dropdown2.bind("<Button-1>", lambda e: self.show_multiselect("Época", ["Década de los 30's", "Década de los 40's", "Década de los 50's", "Década de los 60's", "Década de los 70's", "Década de los 80's", "Década de los 90`s", "Década de los 2000", "Actual"], self.dropdown2, "Época"))
